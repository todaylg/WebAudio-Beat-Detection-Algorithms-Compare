 ...
 * @param  {onBeat}	  callback
 */
var AnalyserBeatDetector = function(analyser, onBeat){
	...
	this.update	= function(delta){
		var rawVolume	= AnalyserBeatDetector.compute(analyser, this.frequencyBinCount)
        if( holdingTime > 0 ){
			holdingTime	-= delta
 ...
 */
AnalyserBeatDetector.compute = function(analyser, width, offset){
	// handle paramerter
...
export default AnalyserBeatDetector;
